...
{
    public partial class TeacherMainView : Form, ITeacherMainView
    {
        //Fields
        ...
        public string TeacherName { get => lbTeacherName.Text; set => lbTeacherName.Text = value; }
        ...
        private void btnProfile_Click(object sender, EventArgs e)
        {
            ...
            ShowProfileView(sender, EventArgs.Empty);
            OpenChildForm(TeacherProfileView.GetInstance());
        }
        ...
        private void btnLessons_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(TeacherLessonView.TeacherLessonView.GetInstance());
        }
        ...
        private void btnTests_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(TeacherTestView.TeacherTestView.GetInstance());
        }
        ...
        #region Singleton
        private static TeacherMainView instance;
        public static TeacherMainView GetInstance()
        {
            if (instance == null || instance.IsDisposed) instance = new TeacherMainView();
            return instance;
        }
        #endregion
    }
