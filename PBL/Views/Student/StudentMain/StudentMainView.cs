...
namespace PBL
{
    public partial class StudentMainView : Form, IStudentMainView
    {
        //Fields
        ...
        private void btnProfile_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(StudentProfileView.GetInstance());
        }
        ...
        private void btnLessons_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(StudentLessonView.GetInstance());
        }
        ...
        #region Singleton
        private static StudentMainView instance;
        public static StudentMainView GetInstance()
        {
            if (instance == null || instance.IsDisposed) instance = new StudentMainView();
            return instance;
        }
        #endregion
    }
